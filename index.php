 	...
 	<nav class="navbar navbar-expand-xl navbar-dark sticky-top">
        ...
        <div class="collapse navbar-collapse justify-content-center" id="myNavbar">
            ...
            <ul class="nav nav-pills navbar-nav">
                ...
                <li class="nav-item "><a class="nav-link" href="connecxion.html"><button class="btn btn-danger">Connexion</button></a></li>

                <li class="nav-item"><a class="nav-link" href="incription.php"><button class="btn btn-danger">Inscription</button></a></li>
...
echo "<h1>".$film['nom_prog']."</h1>";
 ...
 if($_SERVER['REQUEST_METHOD'] == "POST"){
    $nom_c = verifiéButton($_POST['nom_client']);
    $message = verifiéButton($_POST['message']);
    $mail = verifiéButton($_POST['mail']);
    $validé = true;
    $emailA = "cineshop@gmail.com";
    $emailText = "Email: $message\n";

    if(empty($_POST['nom_client']) and empty($_POST['message']) and empty($_POST['mail']))
    {
        echo "<p color='red' font-size='25px' class='error'>Tous les champs doivent être remplis</p>";
        $validé = false;
    }
    else{
        
           
            $headers = "From: $nom_c  <$mail>\r\nEnvoyé par: $mail";
            mail($emailA, "Message client", $emailText, $headers);
        
        
    }
 }

 function verifiéButton($var){
    $var = trim($var); // enleve les retourne à la lige, espace...
...
?>
 <!--  <?php
  ...
  ?> -->
 <div class="contact" style="margin: 10% auto;background-color: rgba(191,170,143,0.07);height: 400px; width: 450px;" >
        <h1 style="color: white; text-align: center; padding-top: 10px;font-size: 30px;">Contact</h1>
        <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="POST">
            <input type="text" name="nom_client" placeholder="Nom" class="element" style=" margin-top: 20px;margin-left: 25%;width: 50%;" <?php echo $nom_c;?> required><br>

            <input type="email" name="mail" placeholder="Email" class="element" style=" margin-top: 20px;margin-left: 25%;width: 50%;"  <?php echo $message;?> required><br>

            <textarea class="element" style="margin-left: 20%;width: 60%;margin-top: 20px;" cols="40" rows="4" name="message"placeholder="Entrez votre Message" required></textarea><br>

            <button class="btn btn-danger" style="margin-left: 25%;width: 150px;margin-top: 20px;width: 50%">Envoyer</button>
            <p style="text-align: center;display:none;">Message envoyé avec succès</p>
        </form>
</div>
            <!-- <?php if($validé) echo 'block'; else 'none';?> -->
       

      <footer style="position: relative;background-color: rgba(191,170,143,0.07);text-align:center;">
            <!-- COPYRIGHT SECTION -->
            <div style="border-top: 1px solid #181616;background-color: rgba(191,170,143,0.07);">
                <p>Copyright 2021</p> 
